...
<section class="section dose-response" aria-labelledby="dose-response-title">
 ...
 <div class="controls">
  ...
  <div class="control"><label>检峰纵轴 / Disk metric</label><select id="dose-response-disk-metric"><option value="recall" selected>Recall</option><option value="precision">Precision</option><option value="high_angle_recall">High-angle recall</option><option value="position_rmse_px">Position RMSE (px)</option><option value="position_p95_px">Position P95 (px)</option><option value="sample_detection_coverage">Sample detection coverage</option></select></div>
 ...
 <p class="chart-note" id="dose-response-note">横轴使用对数刻度；同一噪声层、同一数据集，只有电子剂量变化。</p>
</section>
